...
namespace keys
{
	...
	// ear
		...
		const char* earRightKey[EAR_MAX] =
		{
		...
		const char* eyeRightKey[EYE_MAX]=
		{
		...
		// feet
		const char* footLeftKey[FOOT_MAX] =
		{
		...
		const char* footRightKey[FOOT_MAX] ={
	...
	{
		// hardness
		const char* hardnessKey[JOINTS_MAX] ={
		...
		// position actuator
		const char* actuatorKey[JOINTS_MAX] ={
		...
		// position sensor
		const char* sensorKey[JOINTS_MAX] ={
		...
		// current
		const char* currentKey[JOINTS_MAX] ={
		...
		// temperature
		const char* temperatureKey[JOINTS_MAX] ={
	...
	namespace sensor
	{
		...
		const char* fsrRightKey[FSR_MAX] =
		{
		...
		// switches
		const char* switchKey[SWITCH_MAX]=
		{
		...
		// battery
		const char* batteryKey[BATTERY_MAX]=
		{
